...
function cmdWrapList(pl) {
  warpList(pl);
  return true;
}

mc.regPlayerCmd('warplist', '查看Wrap', cmdWrapList);
mc.regPlayerCmd('warp', '查看Wrap', cmdWrapList);

mc.regPlayerCmd('wrapmanage', '管理Wrap', cmdWrapManage);
