...
function cmdDeathLog(pl) {
  deathLogForm(pl);
  return true;
}

function cmdClearDeathLog(pl) {
  clearLog(pl);
  return true;
}

mc.regPlayerCmd('deathlog', '查看最近死亡记录', cmdDeathLog);
mc.regPlayerCmd('dl', '查看最近死亡记录', cmdDeathLog);

mc.regPlayerCmd('cleardeathlog', '查看最近死亡记录', cmdClearDeathLog);
mc.regPlayerCmd('cdl', '查看最近死亡记录', cmdClearDeathLog);
