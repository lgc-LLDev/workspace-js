...
lxl.require(
  ...
  'https://www.lgc2333.top/llse/NavigationAPI_OldLXL.min.lls.js'
);
const newNavigationTask = lxl.import('NavAPI_newTask');
const clearNavigationTask = lxl.import('NavAPI_clearTask');
const hasNavigationTask = lxl.import('NavAPI_hasTask');
